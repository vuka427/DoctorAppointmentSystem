        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return "<btn class=\"btn-update-doctor btn btn-sm btn-primary \" data-id=\"" + row.USERID + "\" data-doctorname=\"" + row.FULLNAME + "\"> Edit </btn>"
                        + "<btn class=\"btn-delete-doctor btn btn-sm btn-danger ml-2\" data-id=\"" + row.USERID + "\" data-doctorname=\"" + row.FULLNAME + "\" > Delete </btn> "
