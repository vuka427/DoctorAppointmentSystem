...
namespace DoctorAppointmentSystem.Areas.Admin.Controllers
{
    public class DoctorManageController : Controller
    {
        ...
        {
            var l = _dbContext.DEPARTMENT.ToList();
        ...
        public ActionResult LoadDoctorData( JqueryDatatableParam param)
        {
            ...
            var doctor = _dbContext.DOCTOR.Where(d => d.DELETEDFLAG == false).Include("DEPARTMENT").ToList();
            ...
            else
            {
                Func<DoctorViewModel, string> orderingFunction = e =>
                                                           ...
                                                           sortColumnIndex == 9 ? e.CREATEDBY :
                                                           sortColumnIndex == 10 ? e.CREATEDBY :
                                                           sortColumnIndex == 11 ? e.CREATEDBY :
                                                           sortColumnIndex == 12 ? e.CREATEDBY :
                                                           sortColumnIndex == 15 ? e.CREATEDBY :
        ...
        public JsonResult CreateDoctor(DoctorCreateModel model)
        {
            ...
            var hashcode = GenerateHash(model.PASSWORD, SATL);
